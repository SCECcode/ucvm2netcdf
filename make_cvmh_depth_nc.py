...
def read_grid(grd_name,lat_steps,lon_steps,z_steps,lat_size,lon_size,z_size):
    ...
    dataset.comment = "netCDF model extracted from CVM-H using UCVM and converted to netCDF by SCEC. CVM-H flags setting used are: cvmh_param=USE_1D_BKG,False and cvmh_param=USE_GTL,False"
...
if __name__ == "__main__":
    ...
    mesh_file_name = "/Users/maechlin/ucvm_docker/ucvm_v21_10/target/cvmh_depth_socal.txt"
    #
